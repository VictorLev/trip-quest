...
puts "Creating trips..."
gor = Trip.create!(start_point: "-37.594619, 150.842759", end_point: "-38.780864,143.430955", reward_point: sp8.danger, date: "12/03/2024", name: "Great Ocean Road", car: car5)
...
sorrento = Trip.create!(start_point: "-37.798496, 144.979754", end_point: "-38.337904,144.743811", reward_point: sp9.danger, date: "02/01/2024", name: "Sorrento", car: car5)
pi = Trip.create!(start_point: "-37.798665, 144.987446", end_point: "-38.490159,145.201303", reward_point: sp9.danger, date: "09/03/2024", name: "Philip island", car: car3)
torq = Trip.create!(start_point: "-37.709392, 145.078092", end_point: "-38.317497,144.321543", reward_point: sp8.danger, date: "10/12/2023", name: "Torquay", car: car3)
og = Trip.create!(start_point: "-37.809397, 145.078092", end_point: "-38.236541,144.521061", reward_point: sp11.danger, date: "02/03/2024", name: "Ocean grove", car: car5)
bend = Trip.create!(start_point: "-37.690937, 145.078092", end_point: "-36.740942,144.292652",  reward_point: sp12.danger, date: "30/01/2024", name: "Bendigo", car: car3)
epping = Trip.create!(start_point: "-37.809397, 145.078092", end_point: "-37.649890,145.023161", reward_point: sp12.danger, date: "29/02/2024", name: "Epping", car: car5)
ballarat = Trip.create!(start_point: "-37.690937, 145.078092", end_point: "-37.547523,143.850102", reward_point: sp10.danger, date: "12/02/2024", name: "Ballarat", car: car5)
sydney = Trip.create!(start_point: "-37.797219, 144.987657", end_point: "-33.958899,151.036390", reward_point: sp1.danger, date: "05/02/2024", name: "Sydney", car: car5)
drysdale = Trip.create!(start_point: "-37.868674, 144.765000", end_point: "-38.159533,144.581264", reward_point: sp11.danger, date: "01/03/2024", name: "Drysdale", car: car3)
wollongong = Trip.create!(start_point: "-34.808265, 149.596138", end_point: "-34.673787, 150.488712", reward_point: sp3.danger, date: "01/12/2023", name: "wollongong", car: car5)
